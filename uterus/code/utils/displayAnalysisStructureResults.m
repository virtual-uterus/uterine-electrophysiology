...
disp(['  Average propagation velocity: ', num2str(mean(AS.prop_vel)), ...
    ' ± ', num2str(std(AS.prop_vel)), ' mm/s']);
disp(['  Average propagation distance: ', num2str(mean(AS.prop_dist)), ...
